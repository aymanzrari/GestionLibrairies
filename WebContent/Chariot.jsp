		...
		<div class="row">
			...
			<div class="col-sm-8 table-responsive">
				...
				<table class="table table-lg table-dark table-hover">
					...
					<tbody>
						<c:forEach var="i" items="${cart_livre.getLivres()}">
							<tr>
								<td>
									<form action="" method="post">
										<div class="input-group-append">
											<input type="hidden" value="${i.getId_Livre() }"
												name="idLivre"> <input type="text"
												value="${i.getQuentite() }"
												class="form-control form-control" name="Qte">&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<td>${i.getPrix() }</td>
								<td>${i.getPrix()*i.getQuentite() }</td>
								<td>
									<form action="" method="post">
									
										<input type="hidden" value="${i.getId_Livre() }"
											name="idRemove"> <input type="submit"
											value="Delete  From  Carte" class="btn btn-danger"
											name="action">
									</form>
								</td>
							</tr>
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td><span class="txt-bold h5">Totale: ${cart_livre.CalculerMontantTotale() } Dh</span></td>
						</tr>
					</tbody>
				</table>
			...
			<div class="col-sm-8">
				<div class="card bg-dark text-white">
					<div class="card-body">
						...
						la nouvelle quantité puis appuyez sur Button Update.
					</div>
				</div>
				<br>
				<div class="btn-group">
					<a href="ListeLivres.jsp" class="btn btn-success">Continuer
						Votre Achat</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"
